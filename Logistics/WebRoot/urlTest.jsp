...
<html>
  ...
  <body>
   <form action="Customer.insertQuote.action" method="post" enctype="multipart/form-data">
            <input type="text" name="quote.customerID">
            <input type="text" name="quote.freightRouteID">
            <input type="text" name="quote.priceByAmount">
            <input type="text" name="quote.priceByVolume">
            <input type="text" name="quote.priceByWeight">
  ...
  <form action="Customer.deleteQuote.action" method="post" enctype="multipart/form-data" >
